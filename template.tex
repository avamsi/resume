...
\newcommand\resumelinkedin[1]{
    % Trailing % removes space (due to newline?).
    \href{https://www.linkedin.com/in/#1/}{\url{linkedin.com/in/#1}}%
}

\NewDocumentCommand\resumeheader{mmmoo}{
    % @{} removes column padding, X expands to fill remaining width.
...
\newcommand\resumesection[1]{
    \begin{adjustbox}{margin=0 4pt}  % margin=horizontal vertical.
        \begin{tabularx}{\textwidth}{@{}X@{}}
            \pvttextsc{18pt}{#1}~~~\xrfill[3pt]{.4pt}  % ~ is NBSP.
        \end{tabularx}
    \end{adjustbox}
}
...
\NewDocumentCommand\resumelist{moo}{
...
\NewDocumentCommand\resumetwocolslist{omooo}{
    \begin{adjustbox}{margin=0 4pt 0 0}
        \begin{tabularx}{\textwidth}{@{}p{\IfNoValueTF{#1}{1in}{#1}} X@{}}
            {\large$\bullet$}~~#2
            \IfNoValueTF{#3}{}{\vspace{4pt}\\ {\large$\bullet$}~~#3}
